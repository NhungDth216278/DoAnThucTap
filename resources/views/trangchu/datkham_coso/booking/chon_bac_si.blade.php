        ...
        <div class="col-md-4">
            <div class="card shadow-sm border-0 rounded">
                ...
                <div class="card-body">
                    ...
                    <h6 class="fw-bold">
                        <i class="bi bi-heart-pulse"></i> Chuyên khoa: {{ mb_strtoupper($chuyenKhoa->tenkhoa, 'UTF-8') }}
                    </h6>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        <input type="text" id="tuKhoa" class="form-control" placeholder="Tìm kiếm bác sĩ...">
                ...
                <ul id="danhSachBacSi" class="list-group">
                    ...
                    @foreach ($bacSis as $bacSi)
                        <li class="list-group-item">
                            <a class="text-decoration-none" href="{{ route('datkham.thoi-gian', ['coSo' => $coSo->id, 'chuyenKhoa' => $chuyenKhoa->id, 'bacSi' => $bacSi]) }}">

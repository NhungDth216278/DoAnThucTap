    ...
    <div class="col-md-11 col-lg-5">
        <div class="text-center mb-4">
            <a href="{{ route('home.index') }}">
                <img src="{{ asset('imgs/Logo_EbookCare.png') }}" height="50"
                alt="Logo EbookCare">
            </a>
        </div>
        ...
        <div class="card rounded-4 shadow">
            <div class="card-body">
                <p>
                    Nếu bạn quên mật khẩu, đừng lo! Hãy nhập email tài khoản bên dưới
                    và chúng tôi sẽ gửi link đặt lại mật khẩu cho bạn.
                </p>

                <form action="{{ route('forgotPass.proc') }}" method="POST" id="frmForgotPass">
                    @csrf
                    @method('POST')
                    ...
                    <div class="text-end">
                        <input class="btn btn-dark rounded-3" type="submit" value="Gửi" id="btnForgotPass">
                    </div>
                </form>
            </div>
        </div>
